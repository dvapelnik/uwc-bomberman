...
function Player(options) {
    ...
    options.bombOptions = options.bombOptions || {};
    options.bombOptions.detonationTimeout = options.bombOptions.detonationTimeout || 3000;
    options.bombOptions.explosionRadius = options.bombOptions.explosionRadius || 3;
    options.bombOptions.chainExplosion = options.bombOptions.chainExplosion !== undefined
        ? options.bombOptions.chainExplosion : false;
