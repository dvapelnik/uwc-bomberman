...
module.exports = function (io) {
    var ioGame = io
        ...
        .on('connection', function (socket) {
            ...
            game = initGame(manipulators, game, socket, aiOptions);
            ...
            socket.on('new', function () {
                ...
                initGame(manipulators, game, socket, aiOptions);
            });
        });
};
...
function initGame(manipulators, game, socket, aiOptions) {
